...
t=Ts:Ts:T;
semnal=multitrepte(Ts,niv,Durata_treapta); %%Construirea semnalului prin functia multitrepte
figure
...
%%Rezolutia temporala=20ms
Ts=0.02; %%Perioada de esantionare(rezolutia)
t=Ts:Ts:T-3*Ts;   %%Construirea semnalului prin functia multitrepte
